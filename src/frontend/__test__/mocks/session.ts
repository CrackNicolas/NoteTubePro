...
export const session: PropsSession = {
    ...
    status: false,
    lastTime: 'Creada el 10 de jun de 2024 19:40:13hs',
    expiret: 'Mon Jun 10 2024 20:09:25 GMT-0300 (hora estándar de Argentina)',
    origin: {
        ipAdress: '100.123.22.12',
...
export const sessions: PropsSession[] = [
    {
        id: 'ddddd_d2e0jzKi44asdasd2eKJeR',
        status: false,
        lastTime: 'Creada el 10 de jun de 2024 19:40:13hs',
    ...
    },
    {
        ...
        status: true,
        lastTime: 'Creada el 5 de jun de 2024 19:40:13hs',
        expiret: 'Mon Jun 10 2023 10:09:25 GMT-0300 (hora estándar de Argentina)',
        origin: {
            ipAdress: '130.123.22.02',
            city: 'San Miguel De Tucumán'
        }
    }
]