...
export default function ComponentItemTestimoniesHome(props: IItemTestimoniesHome): Component {
    ...
    return (
        <ComponentMotion type="div" descriptionClass="relative pt-4 pb-0 pl-7 pr-3 bg-sixth dark:bg-dark-primary rounded-xl shadow-2xl">
            <div className="relative flex items-center gap-x-6 mb-6">
                ...
                <div className="flex flex-col items-start">
                    <h3 className="text-xl font-semibold text-tertiary dark:text-dark-tertiary ">
                        {title}
                    </h3>
                    ...
                    <p className="text-md text-tertiary dark:text-dark-tertiary  line-clamp-5">
                        {subtitle}
                    </p>
                </div>
            </div>
