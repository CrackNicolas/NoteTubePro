        ...
        <article className={`${opacity && 'opacity-40'} flex flex-col min-h-screen justify-between relative w-full  px-6 lg:px-8 pb-5`}>
            <article className="mt-[130px] flex flex-col items-center gap-y-9">
                ...
                <div className="mt-3 flex items-center justify-center gap-x-6">
                    <ComponentLink url={APP_ROUTES.home} title="Empezar" descriptionClass="group flex items-center gap-x-2 rounded-md border-[1px] dark:border-dark-secondary border-secondary dark:hover:bg-dark-secondary hover:bg-secondary px-3.5 py-2.5 transition duration-700 cursor-pointer">
