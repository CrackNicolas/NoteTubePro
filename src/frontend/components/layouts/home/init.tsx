...
export default function ComponentInit(): Component {
    ...
    return (
        <ComponentMotion type="article" descriptionClass={`${opacity && 'opacity-40'} flex flex-col min-h-screen justify-between relative w-full px-6 lg:px-8 pb-5`}>
            <ComponentMotion type="header" descriptionClass="mt-[120px] flex flex-col items-center gap-y-7">
