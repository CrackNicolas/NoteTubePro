...
export default function ComponentSelect(props: ISelect): Component {
    ...
    return (
        <div ref={refSelect} className='relative flex w-full'>
            ...
            <ul ref={list} className={`${(!open) && 'hidden'} absolute z-10 mt-[32px] w-full dark:bg-dark-primary bg-primary border-[0.1px] ${style.border} rounded-b-md border-opacity-50`}>
                {
                    select != title && (
