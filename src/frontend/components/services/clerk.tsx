...
export function ComponentUserButton() {
    ...
    return <UserButton appearance={{
        ...
        elements: {
            ...
            userButtonPopoverCard: "pb-2.5 mt-1 w-[300px]",
...
export function ComponentSignIn() {
    ...
    return <SignIn afterSignOutUrl="/dashboard/main" appearance={{
        ...
        elements: {
            ...
            footer:"hidden",
            dividerText: "hidden",
            headerTitle: "text-transparent text-center flex flex-col items-center before:text-tertiary before:content-['Iniciar_sesión']",
            headerSubtitle: "my-[-20px] text-sm text-transparent flex flex-col items-center before:text-center before:text-tertiary before:content-['Continua_con_tu_aplicación_de_notas']",
