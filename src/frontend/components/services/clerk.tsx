...
export function ComponentSignIn(): Component {
    ...
    return <SignIn fallbackRedirectUrl={APP_ROUTES.home} appearance={{
        ...
        elements: {
            ...
            card: `pr-6 pt-4 sm:pt-7 pb-4 after:w-full after:text-tertiary after:whitespace-pre-line after:text-sm ${(theme === ThemeName.dark) ? 'after:text-dark-tertiary' : 'after:text-tertiary after:text-opacity-40'} `,
